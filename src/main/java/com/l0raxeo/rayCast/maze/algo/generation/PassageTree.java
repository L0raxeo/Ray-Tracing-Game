package com.l0raxeo.rayCast.maze.algo.generation;

import com.l0raxeo.rayCast.maze.model.Cell;
 ...
 * to the other in one way and the com.l0raxeo.rayCast.maze has no cycles.
 ...
 * It corresponds with the following com.l0raxeo.rayCast.maze where the entrance, the exit
 ...
 * com.l0raxeo.rayCast.maze. After the size is decreased grid turns into the following
 ...
 * |_|_|_| |
 * </pre>
 * And, after "deleting" some random edges, a com.l0raxeo.rayCast.maze becomes:
 * <pre>
 *    _____
 * | |___  |
 * | |  _  |
...
public class PassageTree {
    ...
    /**
     * The height of the com.l0raxeo.rayCast.maze in an imaginary edge form.
     */
    private int height;

    /**
     * The width of the com.l0raxeo.rayCast.maze in an imaginary edge form.
     */
    private int width;
     ...
     * an original form such that a com.l0raxeo.rayCast.maze is simply connected.
     *
